...
#
# auto generated TopDown/TMAM 3.4-full description for Intel 5th gen Core / Core M (code named Broadwell)
...
lines."""
    ...
    def compute(self, EV):
        try:
            self.val = Mem_XSNP_HitM_Cost * \
                EV("OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.SNOOP_HITM",
                   4) / CLKS(self, EV, 4)
            self.thresh = (self.val > 0.1) & self.parent.thresh
        except ZeroDivisionError:
