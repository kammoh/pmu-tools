...
#
# auto generated TopDown/TMAM 3.4-full description for Intel 4rd gen Core (code named Haswell)
...
lines."""
    ...
    def compute(self, EV):
        try:
            self.val = Mem_XSNP_HitM_Cost * \
                EV("OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.HITM_OTHER_CORE",
                   4) / CLKS(self, EV, 4)
            self.thresh = (self.val > 0.1) & self.parent.thresh
        except ZeroDivisionError:
